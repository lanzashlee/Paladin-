...
function Footer() {
  ...
  const renderHourRow = (idx) => {
    ...
    const textClass = isToday ? 'font-semibold text-white' : 'text-gray-300';
    return (
      <div
        key={item.label}
  ...
  return (
    <footer className="bg-[#0a0a0a] text-gray-400 py-12">
      <div className="max-w-7xl mx-auto px-8 w-full flex flex-col gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 text-sm text-gray-200">
              <div className="space-y-1">
                ...
                <Link to="/contact" className="text-gray-300 hover:text-[#0077b6] transition-colors block">
            ...
            <div className="flex gap-4 text-gray-200 pt-2">
              <div className="h-9 w-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:text-[#0077b6] hover:border-[#0077b6] transition-colors" aria-label="Facebook">
              ...
              <div className="h-9 w-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:text-[#0077b6] hover:border-[#0077b6] transition-colors" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
              ...
              <div className="h-9 w-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:text-[#0077b6] hover:border-[#0077b6] transition-colors" aria-label="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
        ...
        <div className="space-y-1 text-sm text-gray-300 mt-4 md:mt-2">
