    ...
    >
      ...
      <div className="lg:hidden mx-auto max-w-[680px] px-4 sm:px-6 pt-4 pb-8 relative z-10">
        ...
        <h1 className="leading-[0.92] tracking-tight text-[#0b347f]">
          <span className="block font-sans text-[3rem] sm:text-[4rem] font-bold">PALADIN</span>
          <span className="block mt-1 text-[1.35rem] sm:text-[1.75rem] font-sans text-[#103472] max-w-[15ch] leading-[1.05]">
        ...
        <div className="mt-4 grid grid-cols-3 gap-0">
          {heroStats.map(([value, label]) => (
            ...
            >
              <p className="text-[#0b3a89] font-extrabold text-[1.25rem] sm:text-[1.5rem] leading-none">
                {value}
              </p>
              <p className="mt-1 text-[0.62rem] sm:text-[0.72rem] uppercase tracking-[0.08em] text-[#7b7b7b] font-semibold text-center leading-tight">
                {label}
              </p>
            </div>
          ))}
        ...
        <div className="mt-5 flex flex-col items-start gap-2.5">
          ...
          >
            Request a <span className="ml-1 font-bold text-[#0b3a89]">Quote</span>
          </Link>
          <a
            href="tel:8056926900"
            className="inline-flex w-[190px] max-w-full items-center justify-center rounded-full border border-[#d8cbb8] bg-[#f0efec] text-[#161a22] text-xs font-semibold py-2.5 shadow-[0_6px_10px_rgba(0,0,0,0.16)] transition-colors hover:bg-[#012E72] hover:text-white"
      ...
      <div className="hidden lg:block relative mx-auto max-w-[1365px] h-[660px] px-4 lg:px-6 xl:px-8 z-10">
        <div className="absolute left-[clamp(12px,3vw,72px)] top-[clamp(88px,8vw,112px)] w-[min(390px,32vw)] max-w-[390px]">
          ...
          <h1 className="leading-[0.92] tracking-tight text-[#0b347f]">
            <span className="block font-sans text-[clamp(3.8rem,6.3vw,6.6rem)] leading-[0.86] font-bold">PALADIN</span>
            <span className="block mt-1 text-[clamp(1.6rem,2.7vw,2.8rem)] font-sans text-[#103472] max-w-[15ch] leading-[0.95]">
              Professional Insurance Solutions
            </span>
          </h1>
