  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="absolute inset-0 h-full w-full origin-top object-cover object-top pointer-events-none z-0 blur-[3px] md:blur-0"
      />

      {/* Mobile readability: blur/dim the background image behind text */}
      <div className="absolute inset-0 bg-[#efeeea]/75 backdrop-blur-sm md:hidden z-0" aria-hidden="true" />

      <div className="lg:hidden mx-auto max-w-[680px] px-4 sm:px-6 pt-4 pb-8 relative z-10">
        <p className="text-[#0f3a88] text-lg sm:text-xl font-medium mb-2" style={{ fontFamily: FONT_BODY }}>Welcome to</p>
        <h1 className="leading-[0.92] tracking-tight text-[#0b347f]">
          <span className="block font-sans text-[3rem] sm:text-[4rem] font-bold" style={{ fontFamily: FONT_DISPLAY }}>PALADIN</span>
          <span className="block mt-1 text-[1.35rem] sm:text-[1.75rem] font-sans text-[#103472] max-w-[15ch] leading-[1.05]" style={{ fontFamily: FONT_SUBHEADING }}>
            Professional Insurance Solutions
          </span>
        </h1>

        <p className="mt-5 text-[#181818] text-sm sm:text-[15px] leading-relaxed max-w-[44ch]" style={{ fontFamily: FONT_BODY }}>
      ...
      <div className="hidden lg:block relative mx-auto max-w-[1365px] h-[660px] px-4 lg:px-6 xl:px-8 z-10">
        <div className="absolute left-[clamp(12px,3vw,72px)] top-[clamp(88px,8vw,112px)] w-[min(390px,32vw)] max-w-[390px]">
          <p className="text-[#0f3a88] text-[clamp(1.2rem,1.5vw,1.9rem)] leading-none font-medium mb-2" style={{ fontFamily: FONT_BODY }}>Welcome to</p>

          <h1 className="leading-[0.92] tracking-tight text-[#0b347f]">
            <span className="block font-sans text-[clamp(3.8rem,6.3vw,6.6rem)] leading-[0.86] font-bold" style={{ fontFamily: FONT_DISPLAY }}>PALADIN</span>
            <span className="block mt-1 text-[clamp(1.6rem,2.7vw,2.8rem)] font-sans text-[#103472] max-w-[15ch] leading-[0.95]" style={{ fontFamily: FONT_SUBHEADING }}>
              Professional Insurance Solutions
            </span>
          </h1>

          <p className="mt-6 text-[#181818] text-[clamp(0.88rem,1.02vw,0.98rem)] leading-relaxed max-w-[40ch]" style={{ fontFamily: FONT_BODY }}>
            Coverage built for professionals, businesses, property owners, and families who want a clear path to the right protection.
          </p>
