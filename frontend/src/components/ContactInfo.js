        ...
        <div className="flex-1 relative z-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-[#010407]/75 font-medium"><a href="https://www.facebook.com/profile.php?id=61573336433957" target="_blank" rel="noopener noreferrer" className="hover:text-[#002DB5] transition-colors">Paladin Professional Insurance Solutions</a></p>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-[#010407]/75 font-medium"><a href="https://www.instagram.com/paladin_professional_insurance/" target="_blank" rel="noopener noreferrer" className="hover:text-[#002DB5] transition-colors">@paladin_professional_insurance</a></p>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-[#010407]/75 font-medium"><a href="https://www.linkedin.com/company/paladin-professional-insurance-solutions/about/" target="_blank" rel="noopener noreferrer" className="hover:text-[#002DB5] transition-colors">Paladin Professional Insurance Solutions</a></p>
            </div>
          </div>
        </div>
